...
class ProjectTasksDialog(QDialog):
    ...
    def __init__(self, project_id, userID):
        super().__init__()
        ...
        self.project_tasks_table = ProjectTasksTable(self.project_id, userID)
    ...
    def open_new_project_task_dialog(self):
        new_project_task_dialog = NewProjectTaskDialog(self.project_id, self.controller.userID)
    ...
    def mark_task_completed(self):
        ...
        if self.check_project_tasks_completed():
            mark_project_complete_dialog = MarkProjectCompleteDialog(self.project_id,self.controller.userID)
